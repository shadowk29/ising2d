...
class ising2d():
    def __init__(self, temperatures, fields, sizes, microstates, algorithm='metropolis', output_folder='.'):
        ...
        if any(np.absolute(fields) > 0.001) and algorithm == 'wolff':
            raise ValueError('The Wolff Algorithm performs poorly for B > 0.001, consider using a smaller field or use Metropolis if a large field is needed')
